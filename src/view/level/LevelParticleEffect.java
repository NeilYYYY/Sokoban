...
public class LevelParticleEffect extends JPanel {
    private final ArrayList<Particle> particles = new ArrayList<>();
    private final Random random = new Random();
    private final int particleCount; // 粒子数量
    private final boolean mode;

    public LevelParticleEffect(int particleCount, boolean mode) {
    ...
    private Color @NotNull [] getColors(float alpha) {
        ...
        if (mode) {
            ...
            colors = new Color[]{
                    new Color(255, 255, 225, (int) (255 * alpha)), // 中心白黄色，动态透明
                    new Color(255, 225, 225, (int) (128 * alpha)), // 渐变为金色，动态透明
